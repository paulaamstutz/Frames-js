  ...
  switch (idAsNumber) {
    case 1:
      ...
      return new NextResponse(`<!DOCTYPE html><html><head>
        ...
        <meta property="fc:frame:button:1:action" content="https://frames-js-six.vercel.app/api/frame?id=2" />
        <meta property="fc:frame:button:2" content="Option 2" />
        <meta property="fc:frame:button:2:action" content="https://frames-js-six.vercel.app/api/frame?id=3" />
        <meta property="fc:frame:button:3" content="Option 3" />
        <meta property="fc:frame:button:3:action" content="https://frames-js-six.vercel.app/api/frame?id=4" />
        <meta property="fc:frame:post_url" content="https://frames-js-six.vercel.app/api/end" />
      </head></html>`);
    ...
    case 3:
      // Frame 3 with a Subscribe button
      return new NextResponse(`<!DOCTYPE html><html><head>
    ...
    case 4:
      // Frame 4 with a Collect Reward button
      return new NextResponse(`<!DOCTYPE html><html><head>
