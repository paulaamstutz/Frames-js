  ...
  switch (idAsNumber) {
    case 1:
      ...
      return new NextResponse(`<!DOCTYPE html><html><head>
        ...
        <meta property="fc:frame:button:1:action" content="/api/frame?id=2" />
        <meta property="fc:frame:button:2" content="Option 2" />
        <meta property="fc:frame:button:2:action" content="/api/frame?id=2" />
        <meta property="fc:frame:button:3" content="Option 3" />
        <meta property="fc:frame:button:3:action" content="/api/frame?id=3" />
